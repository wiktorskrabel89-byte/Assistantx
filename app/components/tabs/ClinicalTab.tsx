...
export const CLINICAL_LABELS = {
  pl: {
    ...
    subtitle: "Prywatna przestrzen dla indywidualnego praktyka",
    langLabel: "Jezyk",
    frameworkLabel: "Schemat diagnostyczny",
    modelLabel: "Model AI",
    noFramework: "Bez schematu",
    customFrameworks: "Wlasne schematy",
    addFramework: "Dodaj schemat",
    editFramework: "Edytuj",
    deleteFramework: "Usun",
    ...
    voiceUnsupported: "Rozpoznawanie mowy niedostepne w tej przegladarce.",
    ...
    defaultModel: "Domyslny (Llama 3.3 70B - darmowy)",
    allModels: "Wszystkie modele (OpenRouter)",
    sessionEmpty: "Brak wiadomosci do eksportu.",
    soapPrompt:
      "Wygeneruj podsumowanie sesji klinicznej w formacie SOAP (Subjective, Objective, Assessment, Plan) na podstawie powyzszej rozmowy. Uzywaj jezyka polskiego.",
    soapPromptEn:
