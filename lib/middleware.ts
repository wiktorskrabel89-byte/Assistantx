...
const AUTH_OPTIONAL_PATH_PREFIXES = ['/auth', '/privacy', '/terms', '/contact', '/faq', '/demo', '/roadmap', '/pricing']
const AUTH_REDIRECT_EXCLUDED_PREFIXES = ['/api', '/auth', '/login', '/privacy', '/terms', '/contact', '/faq', '/demo', '/roadmap', '/pricing']
